			...
			<div id='main-right' style="width: 1000px;">
				<table>
					<form:form commandName="f">
						<tr>
							<td>Prosze wybrać jak produkt będzie sprzedawany:</td>
						</tr>
						<tr>
							<td>
								<input type="hidden" name="_flowExecutionKey" value="${flowExecutionKey}" />
								<form:select name='decyzja' id='decyzja' path="decyzja">
									<form:option value="kup">Kup Teraz</form:option>
									<form:option value="licyt">Licytacja</form:option>
								</form:select>
							</td>
						</tr>
						<tr>
							<td><input type="submit" name="_eventId_kupCzyLicytDecyzja" value="Kolejny krok" /></td>
						</tr>						
					</form:form>
				</table>
			</div>
