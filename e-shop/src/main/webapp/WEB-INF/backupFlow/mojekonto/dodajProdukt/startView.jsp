			...
			<div id='main-right' style="width: 1000px;">
				<table>
					<form:form commandName="produkt">
						...
						<tr>
							<td>Opis:</td>
							<td><form:input name="opis" path="opis" /></td>
						</tr>
						<tr>
							<td>Cena:</td>
						...
						<tr>
							<select name='kategoria' id='kategoria' style="height: 35px; width: 160px; margin-top: 5px; background-color: #EDEDED;">
									<option value="0">WYBIERZ KATEGORIE
									</option>
									<c:forEach items="${katDodaj}" var="element"> 
										<option value="${element.id}">
											${element.nazwa}
										</option>
