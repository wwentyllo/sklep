...
<div id='contener'>
		...
		<div id='main'>
			<div id='main-cenetr' align='center'>
				...
				<h3 style='margin-top: 50px; color: red'>Twoje konto zostało aktywowane. Teraz mozesz się zalogować </h3>
				<a style='color: #8AC74A; font-size: 16px;' href="<c:url value='/logowanie' />">Zaloguj</a>
